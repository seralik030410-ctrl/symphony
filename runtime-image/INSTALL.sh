#!/usr/bin/env bash
# Standalone runtime installation, extracted from the trusted FinCtrl app.
set -euo pipefail
...
shasum -a 256 -c SHA256SUMS || { echo "Kit integrity check failed. Download and extract a fresh kit from FinCtrl." >&2; exit 2; }
...
echo "Runtime ready. Reopen Settings > General in FinCtrl to refresh diagnostics."
