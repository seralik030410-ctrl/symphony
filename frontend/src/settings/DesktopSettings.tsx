...
export function DesktopSettings() {
  ...
  return <><h2>Desktop</h2><section className="settings-card desktop-card">
    <div className="settings-row"><div><strong>OpenAI-compatible API key</strong><small>Хранится в macOS Keychain или Windows Credential Manager. FinCtrl никогда не показывает сохранённое значение обратно.</small></div><span>{present ? <CheckCircle size={17} /> : <Key size={17} />} {present === null ? "Проверяем…" : present ? "Сохранён" : "Не задан"}</span></div>
