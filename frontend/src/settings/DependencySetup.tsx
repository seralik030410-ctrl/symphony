...
export function DependencySetup() {
  ...
  return <details className="dependency-setup">
    ...
    <ol>
      ...
      <li><a href="/api/setup/runtime-kit" className="dependency-download"><DownloadSimple size={16} /> Скачайте набор runtime 6.0</a> и распакуйте ZIP целиком в отдельную папку. Исходники FinCtrl, Python и Node.js на компьютере не нужны.</li>
