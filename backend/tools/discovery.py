...
CAPABILITY_ALIASES = {
    ...
    "office.analyze": "excel xlsx analyze statistics summary formula audit profile dataframe data insights correlation errors",
    ...
    "office.patch": "edit patch update modify cell formula table paragraph slide style format sort fill word excel presentation document docx xlsx pptx",
    "office.chart": "excel xlsx chart graph visualization plot bar line pie area diagram native",
